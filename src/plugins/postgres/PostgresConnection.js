  ...
  async connect() {
    ...
    if (this.populate) {
      try {
        ...
        await populateConnection.query(
          `CREATE TABLE nodes (node_id bigint NOT NULL, location geometry(Point, 0) NOT NULL, PRIMARY KEY (node_id));`
        );
        await populateConnection.query(
        ...
        await populateConnection.query(
          `CREATE TABLE ways (way_id bigint NOT NULL, way_line geometry(LineString, 0), PRIMARY KEY (way_id));`
        );
        await populateConnection.query(
