  ...
  async connect() {
    ...
    if (this.populate) {
      try {
        ...
        await populateConnection.query(`CREATE TABLE \`${this.database}\`.\`ways\` (\`way_id\` bigint(64) NOT NULL, \`way_line\` LINESTRING DEFAULT NULL SRID 0, PRIMARY KEY (\`way_id\`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;`);
